...
function save_image_url_meta_box($post_id, $post, $update)
{
	...
	$meta_box_text_value4 = "";
	$meta_box_text_value5 = "";
	$meta_box_text_value6 = "";
	$meta_box_text_value7 = "";
	
   

    if(isset($_POST["post-secondary-image"]))
    {
        $meta_box_text_value2 = $_POST["post-secondary-image"];
    }   
    update_post_meta($post_id, "post-secondary-image", $meta_box_text_value2);
	
	 if(isset($_POST["post-third-image"]))
    {
        $meta_box_text_value3 = $_POST["post-third-image"];
    }   
    update_post_meta($post_id, "post-third-image", $meta_box_text_value3);
	
	 if(isset($_POST["post-fourth-image"]))
    {
        $meta_box_text_value4 = $_POST["post-fourth-image"];
    }   
    update_post_meta($post_id, "post-fourth-image", $meta_box_text_value4);
	
	 if(isset($_POST["post-fifth-image"]))
    {
        $meta_box_text_value5 = $_POST["post-fifth-image"];
    }   
    update_post_meta($post_id, "post-fifth-image", $meta_box_text_value5);
	
	 if(isset($_POST["post-sixth-image"]))
    {
        $meta_box_text_value6 = $_POST["post-sixth-image"];
    }   
    update_post_meta($post_id, "post-sixth-image", $meta_box_text_value6);
	
	 if(isset($_POST["post-seventh-image"]))
    {
        $meta_box_text_value7 = $_POST["post-seventh-image"];
    }   
    update_post_meta($post_id, "post-seventh-image", $meta_box_text_value7);

   
}

add_action("save_post", "save_image_url_meta_box", 10, 3);
