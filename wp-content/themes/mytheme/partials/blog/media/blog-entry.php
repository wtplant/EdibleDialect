...
<div class="primary-images">
	...
	// Standard link to post
		...
		<a href="#" title="<?php echo esc_attr( the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" class="blog-entry-media-link <?php wpex_img_animation_classes(); ?>">
			<img src="<?php echo $image['url']; ?>" alt="<?php echo the_title(); ?>" width="<?php echo $image['width']; ?>" height="<?php echo $image['height']; ?>" />
		</a>
	<?php endif; ?>
</div>
<div class="secondry-images">    <?php 
