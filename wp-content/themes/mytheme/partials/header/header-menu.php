...
<div id="site-navigation-wrap" class="<?php echo $wrap_classes; ?>">
	...
	<div class="custome-menu">	<?php
		...
		wpex_hook_main_menu_bottom(); ?></div>
        <div class="main-search-cust"><?php get_search_form(); ?></div>

	</nav><!-- #site-navigation -->
</div>     <!-- #site-navigation-wrap -->


<div class="main-search-mobile container"><?php get_search_form(); ?></div>
