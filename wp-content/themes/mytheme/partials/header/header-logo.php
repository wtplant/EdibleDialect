...
<div id="site-logo" class="<?php echo $classes; ?>">
	<a href="http://edibledialect.com"><img src="http://edibledialect.com/wp-content//uploads/2016/10/logo-1.svg" /></a>
</div>
</div>

<div id="site-logo" class="<?php echo $classes; ?> second-headers">
	<?php
	// Display main logo
	if ( '' != $logo_img ) { ?>
...
<li><a href="https://www.instagram.com/edibledialect/"><img src="http://edibledialect.com/wp-content//uploads/2016/10/instagram-svg.svg" /></a></li></ul>
</div><!-- #site-logo -->